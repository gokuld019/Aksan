...
function BlogHero() {
  return (
    <section className="relative overflow-hidden bg-[#0a1e42] min-h-[500px] sm:min-h-[550px] md:min-h-[600px] lg:min-h-[450px]">
      {/* Background image */}
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-6 pt-28 pb-20 md:pt-36 md:pb-28">
